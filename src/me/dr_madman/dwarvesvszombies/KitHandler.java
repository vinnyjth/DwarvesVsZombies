...
public class KitHandler {
	...
	public KitHandler(DwarvesVsZombies instance) {
		plugin = instance;
	...
	public  void addKit(String name, String item, Integer amount) throws Exception{
	...
	public  void addKitItem(String name, String item, Integer amount){
		File data = new File(plugin.getDataFolder(), "Classes");
		Integer itemid = Material.getMaterial(item.toUpperCase()).getId();
		try {
			@SuppressWarnings("unchecked")
	...
	// +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ VIP SECTION +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ //
	public  List<String> listVipKits(){
		File dir1 = plugin.getDataFolder();
	...
	public  void addVIPKitItem(String name, String item, Integer amount){
		...
		public void getKitVIP(Player player, String kit) throws Exception{
			String kitlower = kit.toLowerCase();
			File data = new File(plugin.getDataFolder(), "VIP");
			@SuppressWarnings("unchecked")
			HashMap<Integer, Integer> list = (HashMap<Integer, Integer>) load(data + "/" + kitlower + ".txt");
		...
		public  void addVIPKit(String name, String item, Integer amount) throws Exception{
			Integer itemid = Material.getMaterial(item.toUpperCase()).getId();
			HashMap<Integer, Integer> list = new HashMap<Integer, Integer>();
			list.put(itemid, amount);
			File data = new File(plugin.getDataFolder(), "VIP");
